...
2. **`index.html` (portada)**: hero a pantalla completa con presentación de 4 fotos reales en transición continua (efecto Ken Burns, cambia cada 5s), una ilustración de línea en "relieve" de una mano con uñas superpuesta a la foto (SVG propio, mezcla `overlay`, se adapta al tono de cada foto), parallax sutil de la foto al hacer scroll, entrada del texto escalonada al cargar, insignia de valoración flotante y foto acento tipo "polaroid" en escritorio — todo pensado para que la primera pantalla transmita movimiento y artesanía antes de que la persona haga scroll. Debajo: banner en movimiento, franja de cifras reales, presentación ampliada "quiénes somos", cuadrícula "Explora", tira de galería, reseñas reales y CTA final. Todas las animaciones respetan `prefers-reduced-motion`.
